...
const WelcomeBanner: React.FC<WelcomeBannerProps> = ({ userName, onNewEntry }) => {
  ...
  return (
    <Card className="border-0 shadow-none bg-gradient-to-r from-primary/10 via-primary/5 to-transparent">
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 bg-background/80 backdrop-blur-sm rounded-lg p-3 mt-4 border border-border">
          ...
          <div className="flex-shrink-0">
            <Button onClick={onNewEntry} className="group">
              Start Writing
